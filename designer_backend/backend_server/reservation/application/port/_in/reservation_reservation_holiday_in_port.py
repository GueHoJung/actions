...
class ReservationReservationHolidayInPort(ABC):
    """
    # CLASS : ReservationReservationHolidayInPort
    # AUTHOR : jung-gyuho
...
class ReservationReservationHolidayInCrmImpl(ReservationReservationHolidayInPort):
