...
class ReservationRsrvHolidayScheduleInPort(ABC):
    """
    # CLASS : ReservationRsrvHolidayScheduleInPort
    # AUTHOR : jung-gyuho
...
class ReservationRsrvHolidayScheduleInCrmImpl(ReservationRsrvHolidayScheduleInPort):
