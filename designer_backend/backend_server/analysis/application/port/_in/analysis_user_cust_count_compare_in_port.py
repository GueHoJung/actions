...
class AnalysisUserCustCountCompareInPort(ABC):
    """
    # CLASS : AnalysisUserCustCountCompareInPort
    # AUTHOR : jung-gyuho
...
class AnalysisUserCustCountCompareInCrmImpl(AnalysisUserCustCountCompareInPort):
