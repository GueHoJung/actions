...
class AnalysisUserGrowthRateRankInPort(ABC):
    """
    # CLASS : AnalysisUserGrowthRateRankInPort
    # AUTHOR : jung-gyuho
...
class AnalysisUserGrowthRateRankInCrmImpl(AnalysisUserGrowthRateRankInPort):
