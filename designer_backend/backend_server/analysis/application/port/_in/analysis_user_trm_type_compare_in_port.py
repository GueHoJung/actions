...
class AnalysisUserTrmTypeCompareInPort(ABC):
    """
    # CLASS : AnalysisUserTrmTypeCompareInPort
    # AUTHOR : jung-gyuho
...
class AnalysisUserTrmTypeCompareInCrmImpl(AnalysisUserTrmTypeCompareInPort):
