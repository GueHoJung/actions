...
class AnalysisUserPrepaidSalesRankInPort(ABC):
    """
    # CLASS : AnalysisUserPrepaidSalesRankInPort
    # AUTHOR : jung-gyuho
...
class AnalysisUserPrepaidSalesRankInCrmImpl(AnalysisUserPrepaidSalesRankInPort):
