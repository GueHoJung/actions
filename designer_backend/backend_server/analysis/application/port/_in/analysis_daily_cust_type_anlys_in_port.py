...
class AnalysisDailyCustTypeAnlysInPort(ABC):
    """
    # CLASS : AnalysisDailyCustTypeAnlysInPort
    # AUTHOR : jung-gyuho
...
class AnalysisDailyCustTypeAnlysInCrmImpl(AnalysisDailyCustTypeAnlysInPort):
