...
class AnalysisDailyRetentionAnlysInPort(ABC):
    """
    # CLASS : AnalysisDailyRetentionAnlysInPort
    # AUTHOR : jung-gyuho
...
class AnalysisDailyRetentionAnlysInCrmImpl(AnalysisDailyRetentionAnlysInPort):
