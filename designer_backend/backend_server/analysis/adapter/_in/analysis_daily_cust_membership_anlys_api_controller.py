...
from ...application.service.analysis_daily_cust_membership_anlys_service import AnalysisDailyCustMembershipAnlysService
...
class AnalysisDailyCustMembershipAnlysApiController(APIView):
    """
    # CLASS : AnalysisDailyCustMembershipAnlysApiController
    # AUTHOR : jung-gyuho
    # TIME : 2023/08/07 9:07 PM
    # DESCRIPTION
        - AnalysisDailyCustMembershipAnlysApiController
        - DailyCustMembershipAnlys API
        - CRM 디렉터리 : analysis
        - CRM 서비스 설명 : 분석 고객분석 멤버십분석 - 일
        - CRM 서비스 호출 url : /analysis/getDailyCustMembershipAnlys/
    ...
    @swagger_auto_schema(tags=['CRM SYSTEM - Analysis API'],
                         ...
                         operation_description="# DESIGNER SEVER에서 CRM SYSTEM으로 DailyCustMembershipAnlys 요청 API\n"
                                               "\n"
                                               ...
                                               "|searchStDt    |varchar|20        |TRUE|조회시작일   |20220901|\n"
                                               "|searchEdDt    |varchar|20        |TRUE|조회종료일   |20220930|\n"
    ...
    def post(self, request, *args, **kwargs):
        ...
        # DESCRIPTION
            - API NAME : DailyCustMembershipAnlys API
            - API DESC : CRM DailyCustMembershipAnlys 진입경로
        ...
        service: AnalysisDailyCustMembershipAnlysService = container.analysisDailyCustMembershipAnlysCrmServiceProvider()

        try:
            result = service.analysis_daily_cust_membership_anlys_crm(request.data,
