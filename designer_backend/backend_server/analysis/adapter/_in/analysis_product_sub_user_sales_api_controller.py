...
from ...application.service.analysis_product_sub_user_sales_service import AnalysisProductSubUserSalesService
...
class AnalysisProductSubUserSalesApiController(APIView):
    """
    # CLASS : AnalysisProductSubUserSalesApiController
    # AUTHOR : jung-gyuho
    # TIME : 2023/08/07 1:45 PM
    # DESCRIPTION
        - AnalysisProductSubUserSalesApiController
        - ProductSubUserSales API
        - CRM 디렉터리 : analysis
        - CRM 서비스 설명 : 분석 매출분석 점판별분석 점판2차상세분석
        - CRM 서비스 호출 url : /analysis/getProductSubUserSales/
    ...
    @swagger_auto_schema(tags=['CRM SYSTEM - Analysis API'], operation_summary="CRM Analysis ProductSubUserSales API",
                         operation_description="# DESIGNER SEVER에서 CRM SYSTEM으로 ProductSubUserSales 요청 API\n"
                                               "\n"
                                               ...
                                               "|path    |varchar|20        |TRUE|메뉴패스   |/crm/anlys/sales-anlys-prdct|\n"
                                               "|name    |varchar|20        |TRUE|메뉴명   |sales-anlys-prdct|\n"
                                               "|standard    |varchar|20        |TRUE|조회기준 => 매장/디자이너   |DSGN|\n"
                                               "|shopNm    |varchar|20        |TRUE|매장이름   |준오뷰티|\n"
                                               "|shopId    |varchar|20        |TRUE|매장아이디   |149|\n"
                                               "|shopList    |varchar|20        |TRUE|매장아이디목록   |'1'|\n"
                                               "|shopCnt    |varchar|20        |TRUE|매장개수   |1|\n"
                                               ...
                                               "|tktTpCd    |varchar|20        |TRUE|-   |""|\n"
                                               "|prdcBrndCd    |varchar|20        |TRUE|점판브랜드코드   |TR|\n"
                                               ...
                                               "|chart    |varchar|20        |TRUE|-   |brnd|\n"
                                               "|popPrdcBrnd    |varchar|20        |TRUE|-   |TR|\n"
                                               "|ofdtyCd    |varchar|20        |TRUE|-   |""|\n"
                                               "|prdcLCd    |varchar|20        |TRUE|점판대분류코드   |""|\n"
                                               "|custId    |varchar|20        |TRUE|점판중분류코드   |""|\n"
                                               "\n"
                                               "### Data type : json\n"
                                               "```\n"
                                               "{\n"
                                               ...
                                               "        \"loginShopId\": \"149\",\n"
                                               "        \"loginId\": \"11273\",\n"
                                               "        \"path\": \"/crm/anlys/sales-anlys-prdct\",\n"
                                               "        \"name\": \"sales-anlys-prdct\",\n"
                                               "        \"standard\": \"DSGN\",\n"
                                               "        \"shopNm\": \"준오뷰티\",\n"
                                               "        \"shopId\": \"149\",\n"
                                               "        \"shopList\": \"'1'\",\n"
    ...
    def post(self, request, *args, **kwargs):
        ...
        # DESCRIPTION
            - API NAME : ProductSubUserSales API
            - API DESC : CRM ProductSubUserSales 진입경로
        ...
        service: AnalysisProductSubUserSalesService = container.analysisProductSubUserSalesCrmServiceProvider()

        try:
            result = service.analysis_product_sub_user_sales_crm(request.data,
