...
from ...application.service.analysis_daily_cust_prepaid_anlys_service import AnalysisDailyCustPrepaidAnlysService
...
class AnalysisDailyCustPrepaidAnlysApiController(APIView):
    """
    # CLASS : AnalysisDailyCustPrepaidAnlysApiController
    # AUTHOR : jung-gyuho
    # TIME : 2023/08/07 9:52 PM
    # DESCRIPTION
        - AnalysisDailyCustPrepaidAnlysApiController
        - DailyCustPrepaidAnlys API
        - CRM 디렉터리 : analysis
        - CRM 서비스 설명 : 분석 고객분석 회원권분석 - 일
        - CRM 서비스 호출 url : /analysis/getDailyCustPrepaidAnlys/
    ...
    @swagger_auto_schema(tags=['CRM SYSTEM - Analysis API'], operation_summary="CRM Analysis DailyCustPrepaidAnlys API",
                         operation_description="# DESIGNER SEVER에서 CRM SYSTEM으로 DailyCustPrepaidAnlys 요청 API\n"
                                               "\n"
                                               ...
                                               "|userList    |varchar|20        |TRUE|디자이너아이디목록   |'9829','9827','7921','7738','7666'|\n"
                                               "|userCnt    |varchar|20        |TRUE|-   |5|\n"
                                               ...
                                               "        \"userNm\": \"\",\n"
                                               "        \"userId\": \"\",\n"
                                               "        \"userList\": \"'9829','9827','7921','7738','7666'\",\n"
                                               "        \"userCnt\": 5,\n"
    ...
    def post(self, request, *args, **kwargs):
        ...
        # DESCRIPTION
            - API NAME : DailyCustPrepaidAnlys API
            - API DESC : CRM DailyCustPrepaidAnlys 진입경로
        ...
        service: AnalysisDailyCustPrepaidAnlysService = container.analysisDailyCustPrepaidAnlysCrmServiceProvider()

        try:
            result = service.analysis_daily_cust_prepaid_anlys_crm(request.data,
