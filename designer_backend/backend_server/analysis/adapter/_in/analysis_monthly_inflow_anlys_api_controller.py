...
from ...application.service.analysis_monthly_inflow_anlys_service import AnalysisMonthlyInflowAnlysService
...
class AnalysisMonthlyInflowAnlysApiController(APIView):
    """
    # CLASS : AnalysisMonthlyInflowAnlysApiController
    # AUTHOR : jung-gyuho
    # TIME : 2023/08/08 1:30 PM
    # DESCRIPTION
        - AnalysisMonthlyInflowAnlysApiController
        - MonthlyInflowAnlys API
        - CRM 디렉터리 : analysis
        - CRM 서비스 설명 : 분석 고객분석 유입분석 - 월
        - CRM 서비스 호출 url : /analysis/getMonthlyInflowAnlys/
    ...
    @swagger_auto_schema(tags=['CRM SYSTEM - Analysis API'], operation_summary="CRM Analysis MonthlyInflowAnlys API",
                         operation_description="# DESIGNER SEVER에서 CRM SYSTEM으로 MonthlyInflowAnlys 요청 API\n"
                                               "\n"
                                               ...
                                               "|joinTpCd    |varchar|20        |TRUE|유입경로   |'01','02','03','04','05','08','06'|\n"
                                               "|ageGrpCd    |varchar|20        |TRUE|연령대   |'A50'|\n"
                                               "|userNm    |varchar|20        |TRUE|-   ||\n"
                                               "|userId    |varchar|20        |TRUE|디자이너아이디   ||\n"
                                               "|userList    |varchar|20        |TRUE|디자이너아이디목록   |'9679','8583','7778','6952','5970'|\n"
                                               "|userCnt    |varchar|20        |TRUE|-   |5|\n"
                                               "|realAgeGrpCd    |varchar|20        |TRUE|-   |'50'|\n"
                                               ...
                                               "        \"prdcBrndCd\": null,\n"
                                               "        \"gndrCd\": \"'F','M'\",\n"
                                               "        \"joinTpCd\": \"'01','02','03','04','05','08','06'\",\n"
                                               "        \"ageGrpCd\": \"'A50'\",\n"
                                               "        \"userNm\": \"\",\n"
                                               "        \"userId\": \"\",\n"
                                               "        \"userList\": \"'9679','8583','7778','6952','5970'\",\n"
                                               "        \"userCnt\": 5,\n"
                                               "        \"realAgeGrpCd\": \"'50'\",\n"
                                               "        \"custAnlysDiv\": \"Inflow\"\n"
                                               "    }\n",
    ...
    def post(self, request, *args, **kwargs):
        ...
        # DESCRIPTION
            - API NAME : MonthlyInflowAnlys API
            - API DESC : CRM MonthlyInflowAnlys 진입경로
        ...
        service: AnalysisMonthlyInflowAnlysService = container.analysisMonthlyInflowAnlysCrmServiceProvider()

        try:
            result = service.analysis_monthly_inflow_anlys_crm(request.data,
