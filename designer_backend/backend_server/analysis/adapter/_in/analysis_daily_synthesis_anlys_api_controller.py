...
from ...application.service.analysis_daily_synthesis_anlys_service import AnalysisDailySynthesisAnlysService
...
class AnalysisDailySynthesisAnlysApiController(APIView):
    """
    # CLASS : AnalysisDailySynthesisAnlysApiController
    # AUTHOR : jung-gyuho
    # TIME : 2023/08/07 7:59 PM
    # DESCRIPTION
        - AnalysisDailySynthesisAnlysApiController
        - DailySynthesisAnlys API
        - CRM 디렉터리 : analysis
        - CRM 서비스 설명 : 분석 고객분석 종합분석 - 일
        - CRM 서비스 호출 url : /analysis/getDailySynthesisAnlys/
    ...
    @swagger_auto_schema(tags=['CRM SYSTEM - Analysis API'], operation_summary="CRM Analysis DailySynthesisAnlys API",
                         operation_description="# DESIGNER SEVER에서 CRM SYSTEM으로 DailySynthesisAnlys 요청 API\n"
                                               "\n"
                                               ...
                                               "|userList    |varchar|20        |TRUE|디자이너아이디목록   |'127','338','7738','9827'|\n"
    ...
    def post(self, request, *args, **kwargs):
        ...
        # DESCRIPTION
            - API NAME : DailySynthesisAnlys API
            - API DESC : CRM DailySynthesisAnlys 진입경로
        ...
        service: AnalysisDailySynthesisAnlysService = container.analysisDailySynthesisAnlysCrmServiceProvider()

        try:
            result = service.analysis_daily_synthesis_anlys_crm(request.data,
