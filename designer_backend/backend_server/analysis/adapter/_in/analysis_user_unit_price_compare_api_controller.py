...
from ...application.service.analysis_user_unit_price_compare_service import AnalysisUserUnitPriceCompareService
...
class AnalysisUserUnitPriceCompareApiController(APIView):
    """
    # CLASS : AnalysisUserUnitPriceCompareApiController
    # AUTHOR : jung-gyuho
    # TIME : 2023/08/08 4:43 PM
    # DESCRIPTION
        - AnalysisUserUnitPriceCompareApiController
        - UserUnitPriceCompare API
        - CRM 디렉터리 : analysis
        - CRM 서비스 설명 : 분석 비교분석 객단가비교분석
        - CRM 서비스 호출 url : /analysis/getUserUnitPriceCompare/
    ...
    @swagger_auto_schema(tags=['CRM SYSTEM - Analysis API'], operation_summary="CRM Analysis UserUnitPriceCompare API",
                         operation_description="# DESIGNER SEVER에서 CRM SYSTEM으로 UserUnitPriceCompare 요청 API\n"
                                               "\n"
                                               "|cpID      |varchar|20        |TRUE|기업아이디   |JN|\n"
                                               "|loginShopId      |varchar|20        |TRUE|로그인매장   |103|\n"
                                               "|loginId      |varchar|20        |TRUE|로그인아이디   |11273|\n"
                                               "|path      |varchar|20        |TRUE|메뉴패스   |/crm/anlys/cmpr-anlys-unit-price|\n"
                                               "|name      |varchar|20        |TRUE|메뉴명   |cmpr-anlys-unit-price|\n"
                                               ...
                                               "|term      |varchar|20        |TRUE|월/분기/연도 => month/qrtr/year   |JN|\n"
                                               ...
                                               "|ccustClsfcCdID      |varchar|20        |TRUE|고객유형코드   ||\n"
                                               ...
                                               "|ageGrpCd      |varchar|20        |TRUE|-   |JN|\n"
                                               "|userNm      |varchar|20        |TRUE|디자이너이름   |우주|\n"
                                               "|userId      |varchar|20        |TRUE|디자이너아이디   |8942|\n"
                                               ...
                                               "|searchDiv      |varchar|20        |TRUE|-   |unitPrice|\n"
                                               "\n"
                                               "### Data type : json\n"
                                               "```\n"
                                               "{\n"
                                               ...
                                               "        \"loginShopId\": \"103\",\n"
                                               "        \"loginId\": \"11273\",\n"
                                               "        \"path\": \"/crm/anlys/cmpr-anlys-unit-price\",\n"
                                               "        \"name\": \"cmpr-anlys-unit-price\",\n"
                                               "        \"standard\": \"DSGN\",\n"
                                               "        \"shopNm\": \"코엑스도심공항점\",\n"
                                               "        \"shopId\": \"102\",\n"
                                               "        \"shopList\": \"\",\n"
    ...
    def post(self, request, *args, **kwargs):
        ...
        # DESCRIPTION
            - API NAME : UserUnitPriceCompare API
            - API DESC : CRM UserUnitPriceCompare 진입경로
        ...
        service: AnalysisUserUnitPriceCompareService = container.analysisUserUnitPriceCompareCrmServiceProvider()

        try:
            result = service.analysis_user_unit_price_compare_crm(request.data,
