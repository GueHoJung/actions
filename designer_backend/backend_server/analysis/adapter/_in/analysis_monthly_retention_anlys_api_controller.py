...
from ...application.service.analysis_monthly_retention_anlys_service import AnalysisMonthlyRetentionAnlysService
...
class AnalysisMonthlyRetentionAnlysApiController(APIView):
    """
    # CLASS : AnalysisMonthlyRetentionAnlysApiController
    # AUTHOR : jung-gyuho
    # TIME : 2023/08/08 3:27 PM
    # DESCRIPTION
        - AnalysisMonthlyRetentionAnlysApiController
        - MonthlyRetentionAnlys API
        - CRM 디렉터리 : analysis
        - CRM 서비스 설명 : 분석 고객분석 유지분석 - 월
        - CRM 서비스 호출 url : /analysis/getMonthlyRetentionAnlys/
    ...
    @swagger_auto_schema(tags=['CRM SYSTEM - Analysis API'], operation_summary="CRM Analysis MonthlyRetentionAnlys API",
                         operation_description="# DESIGNER SEVER에서 CRM SYSTEM으로 MonthlyRetentionAnlys 요청 API\n"
                                               "\n"
                                               ...
                                               "|userList    |varchar|20        |TRUE|디자이너아이디목록   |'1331','2414','7197','8990','9858','8059','5012','1956','10749','227','6034','8379'|\n"
                                               "|userCnt    |varchar|20        |TRUE|-   |12|\n"
                                               ...
                                               "        \"userNm\": \"\",\n"
                                               "        \"userId\": \"\",\n"
                                               "        \"userList\": \"'1331','2414','7197','8990','9858','8059','5012','1956','10749','227','6034','8379'\",\n"
                                               "        \"userCnt\": 12,\n"
    ...
    def post(self, request, *args, **kwargs):
        ...
        # DESCRIPTION
            - API NAME : MonthlyRetentionAnlys API
            - API DESC : CRM MonthlyRetentionAnlys 진입경로
        ...
        service: AnalysisMonthlyRetentionAnlysService = container.analysisMonthlyRetentionAnlysCrmServiceProvider()

        try:
            result = service.analysis_monthly_retention_anlys_crm(request.data,
