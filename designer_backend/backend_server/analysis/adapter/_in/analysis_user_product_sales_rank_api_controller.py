...
from ...application.service.analysis_user_product_sales_rank_service import AnalysisUserProductSalesRankService
...
class AnalysisUserProductSalesRankApiController(APIView):
    """
    # CLASS : AnalysisUserProductSalesRankApiController
    # AUTHOR : jung-gyuho
    # TIME : 2023/08/07 5:39 PM
    # DESCRIPTION
        - AnalysisUserProductSalesRankApiController
        - UserProductSalesRank API
        - CRM 디렉터리 : analysis
        - CRM 서비스 설명 : 분석 점판랭크
        - CRM 서비스 호출 url : /analysis/getUserProductSalesRank/
    ...
    @swagger_auto_schema(tags=['CRM SYSTEM - Analysis API'], operation_summary="CRM Analysis UserProductSalesRank API",
                         operation_description="# DESIGNER SEVER에서 CRM SYSTEM으로 UserProductSalesRank 요청 API\n"
                                               "\n"
                                               ...
                                               "|path    |varchar|20        |TRUE|메뉴패스   |/crm/anlys/rank-product|\n"
                                               "|name    |varchar|20        |TRUE|메뉴명   |rank-product|\n"
    ...
    def post(self, request, *args, **kwargs):
        ...
        # DESCRIPTION
            - API NAME : UserProductSalesRank API
            - API DESC : CRM UserProductSalesRank 진입경로
        ...
        service: AnalysisUserProductSalesRankService = container.analysisUserProductSalesRankCrmServiceProvider()

        try:
            result = service.analysis_user_product_sales_rank_crm(request.data,
