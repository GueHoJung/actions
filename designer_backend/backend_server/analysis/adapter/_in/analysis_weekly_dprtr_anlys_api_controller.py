...
from ...application.service.analysis_weekly_dprtr_anlys_service import AnalysisWeeklyDprtrAnlysService
...
class AnalysisWeeklyDprtrAnlysApiController(APIView):
    """
    # CLASS : AnalysisWeeklyDprtrAnlysApiController
    # AUTHOR : jung-gyuho
    # TIME : 2023/08/08 4:20 PM
    # DESCRIPTION
        - AnalysisWeeklyDprtrAnlysApiController
        - WeeklyDprtrAnlys API
        - CRM 디렉터리 : analysis
        - CRM 서비스 설명 : 분석 고객분석 이탈분석 - 주
        - CRM 서비스 호출 url : /analysis/getWeeklyDprtrAnlys/
    ...
    @swagger_auto_schema(tags=['CRM SYSTEM - Analysis API'], operation_summary="CRM Analysis WeeklyDprtrAnlys API",
                         operation_description="# DESIGNER SEVER에서 CRM SYSTEM으로 WeeklyDprtrAnlys 요청 API\n"
                                               "\n"
                                               ...
                                               "|searchStDt    |varchar|20        |TRUE|조회시작일   |202307|\n"
                                               ...
                                               "|joinTpCd    |varchar|20        |TRUE|유입경로코드   |'01','02','03','04','05','06','07','08','09','10','11','99'|\n"
                                               ...
                                               "        \"prdcBrndCd\": null,\n"
                                               "        \"gndrCd\": \"\",\n"
                                               "        \"joinTpCd\": \"'01','02','03','04','05','06','07','08','09','10','11','99'\",\n"
    ...
    def post(self, request, *args, **kwargs):
        ...
        # DESCRIPTION
            - API NAME : WeeklyDprtrAnlys API
            - API DESC : CRM WeeklyDprtrAnlys 진입경로
        ...
        service: AnalysisWeeklyDprtrAnlysService = container.analysisWeeklyDprtrAnlysCrmServiceProvider()

        try:
            result = service.analysis_weekly_dprtr_anlys_crm(request.data,
