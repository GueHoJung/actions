...
from ...application.service.analysis_monthly_cust_membership_anlys_service import \
    AnalysisMonthlyCustMembershipAnlysService
...
class AnalysisMonthlyCustMembershipAnlysApiController(APIView):
    """
    # CLASS : AnalysisMonthlyCustMembershipAnlysApiController
    # AUTHOR : jung-gyuho
    # TIME : 2023/08/07 8:10 PM
    # DESCRIPTION
        - AnalysisMonthlyCustMembershipAnlysApiController
        - MonthlyCustMembershipAnlys API
        - CRM 디렉터리 : analysis
        - CRM 서비스 설명 : 분석 고객분석 멤버십분석 - 월
        - CRM 서비스 호출 url : /analysis/getMonthlyCustMembershipAnlys/
    ...
    @swagger_auto_schema(tags=['CRM SYSTEM - Analysis API'],
                         operation_summary="CRM Analysis MonthlyCustMembershipAnlys API",
                         operation_description="# DESIGNER SEVER에서 CRM SYSTEM으로 MonthlyCustMembershipAnlys 요청 API\n"
                                               "\n"
                                               ...
                                               "|custAnlysDiv    |varchar|20        |TRUE|-   |CustMembership|\n"
                                               "\n"
                                               "### Data type : json\n"
                                               "```\n"
                                               "{\n"
                                               ...
                                               "        \"loginShopId\": \"149\",\n"
                                               "        \"loginId\": \"11273\",\n"
                                               "        \"path\": \"/crm/anlys/cust-anlys-mmbrship\",\n"
                                               "        \"name\": \"cust-anlys-mmbrship\",\n"
                                               "        \"standard\": \"DSGN\",\n"
                                               "        \"shopNm\": \"준오뷰티\",\n"
                                               "        \"shopId\": \"149\",\n"
                                               "        \"shopList\": \"'101'\",\n"
    ...
    def post(self, request, *args, **kwargs):
        ...
        # DESCRIPTION
            - API NAME : MonthlyCustMembershipAnlys API
            - API DESC : CRM MonthlyCustMembershipAnlys 진입경로
        ...
        service: AnalysisMonthlyCustMembershipAnlysService = container.analysisMonthlyCustMembershipAnlysCrmServiceProvider()

        try:
            result = service.analysis_monthly_cust_membership_anlys_crm(request.data,
