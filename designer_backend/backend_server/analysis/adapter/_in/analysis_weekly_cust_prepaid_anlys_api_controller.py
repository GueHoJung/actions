...
from ...application.service.analysis_weekly_cust_prepaid_anlys_service import AnalysisWeeklyCustPrepaidAnlysService
...
class AnalysisWeeklyCustPrepaidAnlysApiController(APIView):
    """
    # CLASS : AnalysisWeeklyCustPrepaidAnlysApiController
    # AUTHOR : jung-gyuho
    # TIME : 2023/08/07 9:43 PM
    # DESCRIPTION
        - AnalysisWeeklyCustPrepaidAnlysApiController
        - WeeklyCustPrepaidAnlys API
        - CRM 디렉터리 : analysis
        - CRM 서비스 설명 : 분석 고객분석 회원권분석 - 주
        - CRM 서비스 호출 url : /analysis/getWeeklyCustPrepaidAnlys/
    ...
    @swagger_auto_schema(tags=['CRM SYSTEM - Analysis API'],
                         operation_summary="CRM Analysis WeeklyCustPrepaidAnlys API",
                         operation_description="# DESIGNER SEVER에서 CRM SYSTEM으로 WeeklyCustPrepaidAnlys 요청 API\n"
                                               "\n"
                                               ...
                                               "|path    |varchar|20        |TRUE|메뉴패스   |/crm/anlys/cust-anlys-prpd|\n"
                                               "|name    |varchar|20        |TRUE|메뉴명   |cust-anlys-prpd|\n"
                                               ...
                                               "|searchEdDt    |varchar|20        |TRUE|조회종료일   |202201|\n"
                                               ...
                                               "|userList    |varchar|20        |TRUE|디자이너아이디목록   |'9827','7738','338','127','6795','6019'|\n"
                                               "|userCnt    |varchar|20        |TRUE|-   |6|\n"
                                               "|custAnlysDiv    |varchar|20        |TRUE|-   |CustPrepaid|\n"
                                               "\n"
                                               "### Data type : json\n"
                                               "```\n"
                                               "{\n"
                                               ...
                                               "        \"loginShopId\": \"149\",\n"
                                               "        \"loginId\": \"11273\",\n"
                                               "        \"path\": \"/crm/anlys/cust-anlys-prpd\",\n"
                                               "        \"name\": \"cust-anlys-prpd\",\n"
                                               "        \"standard\": \"DSGN\",\n"
                                               "        \"shopNm\": \"준오뷰티\",\n"
                                               "        \"shopId\": \"149\",\n"
                                               "        \"shopList\": \"'10'\",\n"
                                               ...
                                               "        \"userNm\": \"\",\n"
                                               "        \"userId\": \"\",\n"
                                               "        \"userList\": \"'9827','7738','338','127','6795','6019'\",\n"
                                               "        \"userCnt\": 6,\n"
                                               "        \"custAnlysDiv\": \"CustPrepaid\"\n"
                                               "    }\n",
    ...
    def post(self, request, *args, **kwargs):
        ...
        # DESCRIPTION
            - API NAME : WeeklyCustPrepaidAnlys API
            - API DESC : CRM WeeklyCustPrepaidAnlys 진입경로
        ...
        service: AnalysisWeeklyCustPrepaidAnlysService = container.analysisWeeklyCustPrepaidAnlysCrmServiceProvider()

        try:
            result = service.analysis_weekly_cust_prepaid_anlys_crm(request.data,
