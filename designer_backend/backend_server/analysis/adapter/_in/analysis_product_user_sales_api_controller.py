...
from ...application.service.analysis_product_user_sales_service import AnalysisProductUserSalesService
...
class AnalysisProductUserSalesApiController(APIView):
    """
    # CLASS : AnalysisProductUserSalesApiController
    # AUTHOR : jung-gyuho
    # TIME : 2023/07/31 4:27 PM
    # DESCRIPTION
        - AnalysisProductUserSalesApiController
        - ProductUserSales API
        - CRM 디렉터리 : analysis
        - CRM 서비스 설명 : 분석 매출분석 점판별분석 (디자이너 별)
        - CRM 서비스 호출 url : /analysis/getProductUserSales/
    ...
    @swagger_auto_schema(tags=['CRM SYSTEM - Analysis API'], operation_summary="CRM Analysis ProductUserSales API",
                         operation_description="# DESIGNER SEVER에서 CRM SYSTEM으로 ProductUserSales 요청 API\n"
                                               "\n"
    ...
    def post(self, request, *args, **kwargs):
        ...
        # DESCRIPTION
            - API NAME : ProductUserSales API
            - API DESC : CRM ProductUserSales 진입경로
            ...
            - REQUEST PARAMS :
                ...
                |prdcBrndCd    |varchar|20        |TRUE|점판브랜드코드   |A매장=7|
        ...
        service: AnalysisProductUserSalesService = container.analysisProductUserSalesCrmServiceProvider()

        try:
            result = service.analysis_product_user_sales_crm(request.data,
