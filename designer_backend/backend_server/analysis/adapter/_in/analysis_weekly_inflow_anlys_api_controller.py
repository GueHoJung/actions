...
from ...application.service.analysis_weekly_inflow_anlys_service import AnalysisWeeklyInflowAnlysService
...
class AnalysisWeeklyInflowAnlysApiController(APIView):
    """
    # CLASS : AnalysisWeeklyInflowAnlysApiController
    # AUTHOR : jung-gyuho
    # TIME : 2023/08/08 2:40 PM
    # DESCRIPTION
        - AnalysisWeeklyInflowAnlysApiController
        - WeeklyInflowAnlys API
        - CRM 디렉터리 : analysis
        - CRM 서비스 설명 : 분석 고객분석 유입분석 - 주
        - CRM 서비스 호출 url : /analysis/getWeeklyInflowAnlys/
    ...
    @swagger_auto_schema(tags=['CRM SYSTEM - Analysis API'], operation_summary="CRM Analysis WeeklyInflowAnlys API",
                         operation_description="# DESIGNER SEVER에서 CRM SYSTEM으로 WeeklyInflowAnlys 요청 API\n"
                                               "\n"
                                               ...
                                               "|searchStDt    |varchar|20        |TRUE|조회시작일   |202209|\n"
                                               "|searchEdDt    |varchar|20        |TRUE|조회종료일   |202211|\n"
                                               ...
                                               "|joinTpCd    |varchar|20        |TRUE|유입경로코드   |'01','07','08','09','10','11','99','06'|\n"
                                               "|ageGrpCd    |varchar|20        |TRUE|연령대코드   |'A10','A30','A60'|\n"
                                               "|userNm    |varchar|20        |TRUE|-   ||\n"
                                               "|userId    |varchar|20        |TRUE|디자이너아이디   ||\n"
                                               "|userList    |varchar|20        |TRUE|디자이너아이디목록   |'9829','127','10786','113'|\n"
                                               "|userCnt    |varchar|20        |TRUE|-   |4|\n"
                                               "|realAgeGrpCd    |varchar|20        |TRUE|-   |'0','10','30','60','70','80','90'|\n"
                                               ...
                                               "        \"prdcBrndCd\": null,\n"
                                               "        \"gndrCd\": \"'F','M'\",\n"
                                               "        \"joinTpCd\": \"'01','07','08','09','10','11','99','06'\",\n"
                                               "        \"ageGrpCd\": \"'A10','A30','A60'\",\n"
                                               "        \"userNm\": \"\",\n"
                                               "        \"userId\": \"\",\n"
                                               "        \"userList\": \"'9829','127','10786','113'\",\n"
                                               "        \"userCnt\": 4,\n"
                                               "        \"realAgeGrpCd\": \"'0','10','30','60','70','80','90'\",\n"
                                               "        \"custAnlysDiv\": \"Inflow\"\n"
                                               "    }\n",
    ...
    def post(self, request, *args, **kwargs):
        ...
        # DESCRIPTION
            - API NAME : WeeklyInflowAnlys API
            - API DESC : CRM WeeklyInflowAnlys 진입경로
        ...
        service: AnalysisWeeklyInflowAnlysService = container.analysisWeeklyInflowAnlysCrmServiceProvider()

        try:
            result = service.analysis_weekly_inflow_anlys_crm(request.data,
