...
from ...application.service.analysis_weekly_cust_membership_anlys_service import \
...
class AnalysisWeeklyCustMembershipAnlysApiController(APIView):
    """
    # CLASS : AnalysisWeeklyCustMembershipAnlysApiController
    # AUTHOR : jung-gyuho
    # TIME : 2023/08/07 8:20 PM
    # DESCRIPTION
        - AnalysisWeeklyCustMembershipAnlysApiController
        - WeeklyCustMembershipAnlys API
        - CRM 디렉터리 : analysis
        - CRM 서비스 설명 :
        - CRM 서비스 호출 url :
    ...
    @swagger_auto_schema(tags=['CRM SYSTEM - Analysis API'],
                         operation_summary="CRM Analysis WeeklyCustMembershipAnlys API",
                         operation_description="# DESIGNER SEVER에서 CRM SYSTEM으로 WeeklyCustMembershipAnlys 요청 API\n"
                                               "\n"
                                               ...
                                               "|searchStDt    |varchar|20        |TRUE|조회시작일   |202208|\n"
                                               ...
                                               "|userList    |varchar|20        |TRUE|디자이너아이디목록   |'9679','8583','8050','7722'|\n"
    ...
    def post(self, request, *args, **kwargs):
        ...
        # DESCRIPTION
            - API NAME : WeeklyCustMembershipAnlys API
            - API DESC : CRM WeeklyCustMembershipAnlys 진입경로
        ...
        service: AnalysisWeeklyCustMembershipAnlysService = container.analysisWeeklyCustMembershipAnlysCrmServiceProvider()

        try:
            result = service.analysis_weekly_cust_membership_anlys_crm(request.data,
