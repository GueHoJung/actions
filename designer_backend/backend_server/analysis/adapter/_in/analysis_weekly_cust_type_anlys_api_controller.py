...
from ...application.service.analysis_weekly_cust_type_anlys_service import AnalysisWeeklyCustTypeAnlysService
...
class AnalysisWeeklyCustTypeAnlysApiController(APIView):
    """
    # CLASS : AnalysisWeeklyCustTypeAnlysApiController
    # AUTHOR : jung-gyuho
    # TIME : 2023/08/07 6:15 PM
    # DESCRIPTION
        - AnalysisWeeklyCustTypeAnlysApiController
        - WeeklyCustTypeAnlys API
        - CRM 디렉터리 : analysis
        - CRM 서비스 설명 : 분석 고객분석 고객유형별분석 - 주
        - CRM 서비스 호출 url : /analysis/getWeeklyCustTypeAnlys/
    ...
    @swagger_auto_schema(tags=['CRM SYSTEM - Analysis API'], operation_summary="CRM Analysis WeeklyCustTypeAnlys API",
                         operation_description="# DESIGNER SEVER에서 CRM SYSTEM으로 WeeklyCustTypeAnlys 요청 API\n"
                                               "\n"
                                               ...
                                               "|userList    |varchar|20        |TRUE|디자이너아이디목록   |'9829','9827','7921'|\n"
    ...
    def post(self, request, *args, **kwargs):
        ...
        # DESCRIPTION
            - API NAME : WeeklyCustTypeAnlys API
            - API DESC : CRM WeeklyCustTypeAnlys 진입경로
        ...
        service: AnalysisWeeklyCustTypeAnlysService = container.analysisWeeklyCustTypeAnlysCrmServiceProvider()

        try:
            result = service.analysis_weekly_cust_type_anlys_crm(request.data,
