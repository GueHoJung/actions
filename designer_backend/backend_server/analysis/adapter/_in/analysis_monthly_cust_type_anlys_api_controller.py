...
from ...application.service.analysis_monthly_cust_type_anlys_service import AnalysisMonthlyCustTypeAnlysService
...
class AnalysisMonthlyCustTypeAnlysApiController(APIView):
    """
    # CLASS : AnalysisMonthlyCustTypeAnlysApiController
    # AUTHOR : jung-gyuho
    # TIME : 2023/08/07 6:01 PM
    # DESCRIPTION
        - AnalysisMonthlyCustTypeAnlysApiController
        - MonthlyCustTypeAnlys API
        - CRM 디렉터리 : analysis
        - CRM 서비스 설명 : 분석 고객분석 고객유형별분석 - 월
        - CRM 서비스 호출 url : /analysis/getMonthlyCustTypeAnlys/
    ...
    @swagger_auto_schema(tags=['CRM SYSTEM - Analysis API'], operation_summary="CRM Analysis MonthlyCustTypeAnlys API",
                         operation_description="# DESIGNER SEVER에서 CRM SYSTEM으로 MonthlyCustTypeAnlys 요청 API\n"
                                               "\n"
                                               ...
                                               "|custAnlysDiv    |varchar|20        |TRUE|고객유형코드   |CustType|\n"
                                               "\n"
                                               "### Data type : json\n"
                                               "```\n"
                                               "{\n"
    ...
    def post(self, request, *args, **kwargs):
        ...
        # DESCRIPTION
            - API NAME : MonthlyCustTypeAnlys API
            - API DESC : CRM MonthlyCustTypeAnlys 진입경로
        ...
        service: AnalysisMonthlyCustTypeAnlysService = container.analysisMonthlyCustTypeAnlysCrmServiceProvider()

        try:
            result = service.analysis_monthly_cust_type_anlys_crm(request.data,
