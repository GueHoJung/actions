...
from ...application.service.analysis_monthly_synthesis_anlys_service import AnalysisMonthlySynthesisAnlysService
...
class AnalysisMonthlySynthesisAnlysApiController(APIView):
    """
    # CLASS : AnalysisMonthlySynthesisAnlysApiController
    # AUTHOR : jung-gyuho
    # TIME : 2023/08/07 7:25 PM
    # DESCRIPTION
        - AnalysisMonthlySynthesisAnlysApiController
        - MonthlySynthesisAnlys API
        - CRM 디렉터리 : analysis
        - CRM 서비스 설명 : 분석 고객분석 종합분석 - 월
        - CRM 서비스 호출 url : /analysis/getMonthlySynthesisAnlys/
    ...
    @swagger_auto_schema(tags=['CRM SYSTEM - Analysis API'], operation_summary="CRM Analysis MonthlySynthesisAnlys API",
                         operation_description="# DESIGNER SEVER에서 CRM SYSTEM으로 MonthlySynthesisAnlys 요청 API\n"
                                               "\n"
                                               ...
                                               "|userList    |varchar|20        |TRUE|디자이너아이디목록   |'9829','9827','9743','7921'|\n"
    ...
    def post(self, request, *args, **kwargs):
        ...
        # DESCRIPTION
            - API NAME : MonthlySynthesisAnlys API
            - API DESC : CRM MonthlySynthesisAnlys 진입경로
        ...
        service: AnalysisMonthlySynthesisAnlysService = container.analysisMonthlySynthesisAnlysCrmServiceProvider()

        try:
            result = service.analysis_monthly_synthesis_anlys_crm(request.data,
