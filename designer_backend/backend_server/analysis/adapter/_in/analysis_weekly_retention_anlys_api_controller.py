...
from ...application.service.analysis_weekly_retention_anlys_service import AnalysisWeeklyRetentionAnlysService
...
class AnalysisWeeklyRetentionAnlysApiController(APIView):
    """
    # CLASS : AnalysisWeeklyRetentionAnlysApiController
    # AUTHOR : jung-gyuho
    # TIME : 2023/08/08 3:41 PM
    # DESCRIPTION
        - AnalysisWeeklyRetentionAnlysApiController
        - WeeklyRetentionAnlys API
        - CRM 디렉터리 : analysis
        - CRM 서비스 설명 : 분석 고객분석 유지분석 - 주
        - CRM 서비스 호출 url : /analysis/getWeeklyRetentionAnlys/
    ...
    @swagger_auto_schema(tags=['CRM SYSTEM - Analysis API'], operation_summary="CRM Analysis WeeklyRetentionAnlys API",
                         operation_description="# DESIGNER SEVER에서 CRM SYSTEM으로 WeeklyRetentionAnlys 요청 API\n"
                                               "\n"
                                               ...
                                               "|userList    |varchar|20        |TRUE|디자이너아이디목록   |'1331','2414','8990','9858','8059','5012','1956','10749','227','6034','8379','7349','287'|\n"
                                               "|userCnt    |varchar|20        |TRUE|-   |13|\n"
                                               ...
                                               "        \"userNm\": \"\",\n"
                                               "        \"userId\": \"\",\n"
                                               "        \"userList\": \"'1331','2414','8990','9858','8059','5012','1956','10749','227','6034','8379','7349','287'\",\n"
                                               "        \"userCnt\": 13,\n"
    ...
    def post(self, request, *args, **kwargs):
        ...
        # DESCRIPTION
            - API NAME : WeeklyRetentionAnlys API
            - API DESC : CRM WeeklyRetentionAnlys 진입경로
        ...
        service: AnalysisWeeklyRetentionAnlysService = container.analysisWeeklyRetentionAnlysCrmServiceProvider()

        try:
            result = service.analysis_weekly_retention_anlys_crm(request.data,
