...
from ...application.service.analysis_ticket_user_sales_service import AnalysisTicketUserSalesService
...
class AnalysisTicketUserSalesApiController(APIView):
    """
    # CLASS : AnalysisTicketUserSalesApiController
    # AUTHOR : jung-gyuho
    # TIME : 2023/08/07 4:32 PM
    # DESCRIPTION
        - AnalysisTicketUserSalesApiController
        - TicketUserSales API
        - CRM 디렉터리 : analysis
        - CRM 서비스 설명 : 분석 매출분석 횟수권분석
        - CRM 서비스 호출 url : /analysis/getTicketUserSales/
    ...
    @swagger_auto_schema(tags=['CRM SYSTEM - Analysis API'], operation_summary="CRM Analysis TicketUserSales API",
                         operation_description="# DESIGNER SEVER에서 CRM SYSTEM으로 TicketUserSales 요청 API\n"
                                               "\n"
                                               ...
                                               "|path    |varchar|20        |TRUE|메뉴패스   |/crm/anlys/sales-anlys-tctk|\n"
                                               "|name    |varchar|20        |TRUE|메뉴명   |sales-anlys-tctk|\n"
                                               ...
                                               "|userCnt    |varchar|20        |TRUE|-   |""|\n"
                                               "|isChart    |varchar|20        |TRUE|-   |true|\n"
                                               "|chartTerm    |varchar|20        |TRUE|-   |month|\n"
                                               "|chart    |varchar|20        |TRUE|-   |saleUse|\n"
                                               "|subChart    |varchar|20        |TRUE|-   |sale|\n"
                                               "|itemClsL    |varchar|20        |TRUE|-   |""|\n"
                                               "\n"
                                               "### Data type : json\n"
                                               "```\n"
                                               "{\n"
                                               ...
                                               "        \"loginShopId\": \"149\",\n"
                                               "        \"loginId\": \"11273\",\n"
                                               "        \"path\": \"/crm/anlys/sales-anlys-tctk\",\n"
                                               "        \"name\": \"sales-anlys-tctk\",\n"
                                               "        \"standard\": \"DSGN\",\n"
                                               "        \"shopNm\": \"준오뷰티\",\n"
                                               "        \"shopId\": \"149\",\n"
                                               "        \"shopList\": \"'10'\",\n"
    ...
    def post(self, request, *args, **kwargs):
        ...
        # DESCRIPTION
            - API NAME : TicketUserSales API
            - API DESC : CRM TicketUserSales 진입경로
        ...
        service: AnalysisTicketUserSalesService = container.analysisTicketUserSalesCrmServiceProvider()

        try:
            result = service.analysis_ticket_user_sales_crm(request.data, accessToken=kwargs.get('accessToken', 'None'),
