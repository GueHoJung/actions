...
from ...application.service.analysis_monthly_cust_prepaid_anlys_service import AnalysisMonthlyCustPrepaidAnlysService
...
class AnalysisMonthlyCustPrepaidAnlysApiController(APIView):
    """
    # CLASS : AnalysisMonthlyCustPrepaidAnlysApiController
    # AUTHOR : jung-gyuho
    # TIME : 2023/08/07 9:34 PM
    # DESCRIPTION
        - AnalysisMonthlyCustPrepaidAnlysApiController
        - MonthlyCustPrepaidAnlys API
        - CRM 디렉터리 : analysis
        - CRM 서비스 설명 : 분석 고객분석 회원권분석 - 월
        - CRM 서비스 호출 url : /analysis/getMonthlyCustPrepaidAnlys/
    ...
    @swagger_auto_schema(tags=['CRM SYSTEM - Analysis API'],
                         operation_summary="CRM Analysis MonthlyCustPrepaidAnlys API",
                         operation_description="# DESIGNER SEVER에서 CRM SYSTEM으로 MonthlyCustPrepaidAnlys 요청 API\n"
                                               "\n"
                                               ...
                                               "|userList    |varchar|20        |TRUE|디자이너아이디목록   |'9827','7738','338','127'|\n"
    ...
    def post(self, request, *args, **kwargs):
        ...
        # DESCRIPTION
            - API NAME : MonthlyCustPrepaidAnlys API
            - API DESC : CRM MonthlyCustPrepaidAnlys 진입경로
        ...
        service: AnalysisMonthlyCustPrepaidAnlysService = container.analysisMonthlyCustPrepaidAnlysCrmServiceProvider()

        try:
            result = service.analysis_monthly_cust_prepaid_anlys_crm(request.data,
