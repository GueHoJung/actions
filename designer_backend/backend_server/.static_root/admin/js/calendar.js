...
'use strict';
{
    ...
    const CalendarNamespace = {
        ...
        draw: function(month, year, div_id, callback, selected) { // month = 1-12, year = 1-9999
            ...
            // ```
            //
            // The day variable above will be 1 instead of 2 _in, say, US Pacific time
            // zone.
    ...
    function Calendar(div_id, callback, selected) {
        // div_id (string) is the ID of the element _in which the calendar will
        //     be displayed
        // callback (string) is the name of a JavaScript function that will be
        //     called with the parameters (year, month, day) when a day _in the
        //     calendar is clicked
        this.div_id = div_id;
