...
'use strict';
{
    const DateTimeShortcuts = {
        ...
        // Add a warning when the time zone _in the browser and backend do not match.
        ...
        addClock: function(inp) {
            ...
            // The list of choices can be overridden _in JavaScript like this:
        ...
        openClock: function(num) {
            ...
            if (window.getComputedStyle(document.body).direction !== 'rtl') {
                ...
                // since style's width is _in em, it'd be tough to calculate
        ...
        openCalendar: function(num) {
            ...
            // Determine if the current value _in the input has a valid date.
