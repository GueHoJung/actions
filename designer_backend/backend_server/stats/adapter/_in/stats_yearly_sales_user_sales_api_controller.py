...
from ...application.service.stats_yearly_sales_user_sales_service import StatsYearlySalesUserSalesService
...
class StatsYearlySalesUserSalesApiController(APIView):
    """
    # CLASS : StatsYearlySalesUserSalesApiController
    # AUTHOR : jung-gyuho
    # TIME : 2023/07/31 6:18 PM
    # DESCRIPTION
        - StatsYearlySalesUserSalesApiController
        - YearlySalesUserSales API
        - CRM 디렉터리 : stats
        - CRM 서비스 설명 : 통계 디자이너 매출조회 결제수단
        - CRM 서비스 호출 url : /stats/getYearlySalesUserSales/
    ...
    @swagger_auto_schema(tags=['CRM SYSTEM - Stats API'], operation_summary="CRM Stats YearlySalesUserSales API",
                         operation_description="# DESIGNER SEVER에서 CRM SYSTEM으로 YearlySalesUserSales 요청 API\n"
                                               "\n"
    ...
    def post(self, request, *args, **kwargs):
        ...
        # DESCRIPTION
            - API NAME : YearlySalesUserSales API
            - API DESC : CRM YearlySalesUserSales 진입경로
        ...
        service: StatsYearlySalesUserSalesService = container.statsYearlySalesUserSalesCrmServiceProvider()

        try:
            result = service.stats_yearly_sales_user_sales_crm(request.data, accessToken=kwargs.get('accessToken', 'None'),
