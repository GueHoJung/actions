...
from ...application.service.stats_yearly_sales_user_performance_service import StatsYearlySalesUserPerformanceService
...
class StatsYearlySalesUserPerformanceApiController(APIView):
    """
    # CLASS : StatsYearlySalesUserPerformanceApiController
    # AUTHOR : jung-gyuho
    # TIME : 2023/07/31 5:21 PM
    # DESCRIPTION
        - StatsYearlySalesUserPerformanceApiController
        - YearlySalesUserPerformance API
        - CRM 디렉터리 : stats
        - CRM 서비스 설명 : 통계 매출통계 디자이너 매출연보
        - CRM 서비스 호출 url : /stats/getYearlySalesUserPerformance/
    ...
    @swagger_auto_schema(tags=['CRM SYSTEM - Stats API'], operation_summary="CRM Stats YearlySalesUserPerformance API",
                         operation_description="# DESIGNER SEVER에서 CRM SYSTEM으로 YearlySalesUserPerformance 요청 API\n"
                                               "\n"
    ...
    def post(self, request, *args, **kwargs):
        ...
        # DESCRIPTION
            - API NAME : YearlySalesUserPerformance API
            - API DESC : CRM YearlySalesUserPerformance 진입경로
        ...
        service: StatsYearlySalesUserPerformanceService = container.statsYearlySalesUserPerformanceCrmServiceProvider()

        try:
            result = service.stats_yearly_sales_user_performance_crm(request.data, accessToken=kwargs.get('accessToken', 'None'),
