...
from ...application.service.stats_yearly_sales_user_order_type_sales_service import \
...
class StatsYearlySalesUserOrderTypeSalesApiController(APIView):
    """
    # CLASS : StatsYearlySalesUserOrderTypeSalesApiController
    # AUTHOR : jung-gyuho
    # TIME : 2023/08/04 1:42 PM
    # DESCRIPTION
        - StatsYearlySalesUserOrderTypeSalesApiController
        - YearlySalesUserOrderTypeSales API
        - CRM 디렉터리 : stats
        - CRM 서비스 설명 : 디자이너 매출조회 - 연, (타임아웃 20초 발생, 데이터 많아서 조회 속도 느림, 처리 방안 확인 필요)
        - CRM 서비스 호출 url : /stats/getYearlySalesUserOrdTypeSales/
    ...
    @swagger_auto_schema(tags=['CRM SYSTEM - Stats API'],
                         operation_summary="CRM Stats YearlySalesUserOrderTypeSales API",
                         operation_description="# DESIGNER SEVER에서 CRM SYSTEM으로 YearlySalesUserOrderTypeSales 요청 API\n"
                                               "\n"
                                               ...
                                               "|term    |varchar|20        |TRUE|월 / 일 => month / day   |year|\n"
                                               "|salesUserId    |varchar|20        |TRUE|디자이너아이디   |5584|\n"
                                               "\n"
                                               "### Data type : json\n"
                                               "```\n"
                                               "{\n"
    ...
    def post(self, request, *args, **kwargs):
        ...
        # DESCRIPTION
            - API NAME : YearlySalesUserOrderTypeSales API
            - API DESC : CRM YearlySalesUserOrderTypeSales 진입경로
        ...
        service: StatsYearlySalesUserOrderTypeSalesService = container.statsYearlySalesUserOrderTypeSalesCrmServiceProvider()

        try:
            result = service.stats_yearly_sales_user_order_type_sales_crm(request.data, accessToken=kwargs.get('accessToken', 'None'),
