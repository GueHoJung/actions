...
from ...application.service.stats_monthly_sales_user_performance_service import StatsMonthlySalesUserPerformanceService
...
class StatsMonthlySalesUserPerformanceApiController(APIView):
    """
    # CLASS : StatsMonthlySalesUserPerformanceApiController
    # AUTHOR : jung-gyuho
    # TIME : 2023/07/31 5:33 PM
    # DESCRIPTION
        - StatsMonthlySalesUserPerformanceApiController
        - MonthlySalesUserPerformance API
        - CRM 디렉터리 : stats
        - CRM 서비스 설명 : 통계 디자이너 매출조회 매출월보
        - CRM 서비스 호출 url : /stats/getMonthlySalesUserPerformance/
    ...
    @swagger_auto_schema(tags=['CRM SYSTEM - Stats API'], operation_summary="CRM Stats MonthlySalesUserPerformance API",
                         operation_description="# DESIGNER SEVER에서 CRM SYSTEM으로 MonthlySalesUserPerformance 요청 API\n"
                                               "\n"
    ...
    def post(self, request, *args, **kwargs):
        ...
        # DESCRIPTION
            - API NAME : MonthlySalesUserPerformance API
            - API DESC : CRM MonthlySalesUserPerformance 진입경로
        ...
        service: StatsMonthlySalesUserPerformanceService = container.statsMonthlySalesUserPerformanceCrmServiceProvider()

        try:
            result = service.stats_monthly_sales_user_performance_crm(request.data, accessToken=kwargs.get('accessToken', 'None'),
