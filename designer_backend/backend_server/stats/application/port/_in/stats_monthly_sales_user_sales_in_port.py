...
class StatsMonthlySalesUserSalesInPort(ABC):
    """
    # CLASS : StatsMonthlySalesUserSalesInPort
    # AUTHOR : jung-gyuho
...
class StatsMonthlySalesUserSalesInCrmImpl(StatsMonthlySalesUserSalesInPort):
